...
export default function ContentCard({ collectionId }: ContentCardProps) {
    ...
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 px-4 py-3 bg-white rounded-lg shadow-sm border border-gray-100">
        <span className="text-gray-700 font-medium text-sm sm:text-base">
          Content Entries for Collection:{" "}
          <span className="text-indigo-600 font-bold">{collectionId}</span>
        </span>
                  ...
                  >
                    ...
                    <td className="px-4 py-4 font-semibold text-gray-900 text-sm whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <Badge
                          className={`text-[0.6rem] font-bold px-1 py-0 rounded ${
                            content.status === "live"
                              ? "bg-red-400"
